...
@WebServlet("/AddNewSubLoadJobName")
public class AddNewSubLoadJobName extends HttpServlet {
	private static final long serialVersionUID = 1L;
	final static Logger logger = Logger.getLogger(AddNewJob.class);

	public AddNewSubLoadJobName() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String loadName = ShellScripting.loadName;
...
//		AddNew.addNewEntry(loadName, subLoadName, jobName, enabledFlg, jobOrder, jobType, jobPath, loadId, subLoadId, loadSchedule);
